...
@section('content')
    <form action="{{ route('product.update', $edit->id) }}" method="post">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-5">
                <input type="number" class="form-control" name="product_qty" value="<?= $edit->product_qty ?>" required>
            </div>
        </div>
        <div class="mb-3 row">
            <div class="col-sm-2">
            ...
            <div class="col-sm-5">
                <input type="number" class="form-control" name="product_price" value="<?= $edit->product_price ?>" required>
            </div>
        </div>
        <div class="mb-3 row">
            <div class="col-sm-10">
